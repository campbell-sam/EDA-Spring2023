...
```{r}
#7 
CombinedDatasets <- rbind(EPAair_O3_NC2018_Processed, EPAair_O3_NC2019_Processed, EPAair_PM25_NC2018_Processed, EPAair_PM25_NC2019_Processed)

#8 
CombinedDatasets <- mutate(CombinedDatasets, month = month(Date)) %>% 
  mutate(CombinedDatasets, year = year(Date))

#9

#10
dim(CombinedDatasets)

#11
write.csv(CombinedDatasets, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv")
...
> Answer: 'drop_na' allows us to drop rows that contain a missing value, whereas 'na.omit' removes rows that have an incomplete value.
