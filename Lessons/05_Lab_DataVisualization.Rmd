...
ggplot(data=data.frame(x=0,y=0))+
  ...
  geom_text(
    x=0,
    y=0.025,
    #paste command creates the text you see in the plot, with commas indicating spaces between the words
    #Look up mathjax documentation for how to write formula language like squared below
