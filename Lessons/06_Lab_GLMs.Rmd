...
#see KEY file for these 2nd two plots
O3.boxplot <-
...
#r squared value means 13% of PM2.5 is explained by Ozone
PM25Ozone.regression <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(PM25Ozone.regression)
